# Instillation
default[:redis][:version]         = '3.0.1'
default[:redis][:source_checksum] = 'fe1d06599042bfe6a0e738542f302ce9533dde88'
...
default[:redis][:repl_diskless_sync]          = 'no'
default[:redis][:repl_diskless_sync_delay]    = 5
